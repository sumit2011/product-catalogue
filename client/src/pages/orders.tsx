    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div>
          ...
          <div className="text-xs text-gray-500">{row.original.customerEmail || "No email"}</div>
        </div>
      ),
    },
    {
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Manage customer orders and track revenue</p>
      </div>
            ...
            <div className="grid gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm">{selectedOrder.customerEmail || "No email provided"}</p>
                  <p className="text-sm">{selectedOrder.customerPhone || "No phone provided"}</p>
                </div>
                <div>
                  ...
                  <p className="mt-2 text-sm font-medium">Total Amount: ₹{selectedOrder.totalAmount.toLocaleString()}</p>
                </div>
              </div>
